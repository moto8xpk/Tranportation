...
export class TranportPageComponent implements OnInit {
  ...
  ngOnInit() {
    this.tabList=[
      ...
      {id:1,link:'/tranport/auto-setup',title:"Auto Setup",disable:false},
      {id:2,link:'/tranport/detail-list',title:"Detail List",disable:false},
      {id:3,link:'/tranport/notice-change',title:"Notice Change",disable:false},
      {id:4,link:'/tranport/import',title:"Import",disable:false},
      {id:5,link:'/tranport/report',title:"Report",disable:false},
    ]
  }
